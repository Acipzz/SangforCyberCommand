...
<html lang="en">
  ...
  <head>
    ...
    <title>Sangfot Cyber Command</title>
...
<body>
  ...
  <div class="swiper-container" id="top">
        <div class="slide-inner" style="background-image:url(frontend/assets/images/main_banner.png)">
          <div class="container" >
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
                  <h2>Cybersecurity Made Simple with Sangfor Cyber Command</h2>
    ...
    <div class="contact" style="background-image: url(frontend/assets/images/about_page.png)">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="left-content">
                ...
                <p>It provides a range of security solutions such as threat detection, incident response, and compliance management. With Sangfor Cyber Command, organizations can monitor their network traffic, 
                    analyze security events, and respond to incidents quickly and efficiently.</p>

                <p>The platform uses advanced machine learning algorithms and big data analytics to identify and prevent cyber-attacks before they cause damage.  It also offers a user-friendly dashboard that enables 
                    businesses to track their security posture in real-time and make informed decisions based on the insights provided.</p>
          ...
          <div class="col-lg-6">
              <div class="section-heading-wrapper">
                <div class="section-heading">
                    <h6>Dapatkan Free Trial selama 1 bulan,</h6>
                    ...
                    <form id="contact" action="" method="get">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <fieldset>
                                    <p>Last Name</p>
                                    <input type="name" name="name" id="name" placeholder="Last Name" autocomplete="on" required>
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
                                    <p>Corporate Email</p>
                                    <input type="text" name="email" id="email" pattern="[^ @]*@[^ @]*" placeholder="email@mail.com" required="">
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
                                    <p>Job Title</p>
                                    <input type="job" name="job" id="job" placeholder="Your job" required="">
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
                                    <p>Company Name</p>
                                    <input type="company" name="company" id="company" placeholder="Your Company" required="">
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
                            ...
                            <div class="col-lg-12 button-container">
                                <fieldset>
                                    <button type="submit" id="form-submit" class="green-button">Send</button>
                                </fieldset>
                            </div>
                        </div>
                    </form>
  ...
  <section class="services" id="services" style="background-image: url(frontend/assets/images/advantage_section.png)">
    <div class="container">
        <div class="header-text">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="service-item">
                    <img src="frontend/assets/images/Virus_Scan.png" alt="Advanced Threat Detection" class="service-icon" />
            ...
            <div class="col-lg-6">
                <div class="service-item">
                    <img src="frontend/assets/images/Anti_Virus.png" alt="Advanced Threat Detection" class="service-icon" />
                    <h4>Network Visibility and Control</h4>
            ...
            <div class="col-lg-6">
                <div class="service-item">
                    <img src="frontend/assets/images/Upload.png" alt="Advanced Threat Detection" class="service-icon" />
            ...
            <div class="col-lg-6">
                <div class="service-item">
                    <img src="frontend/assets/images/Cyber.png" alt="Advanced Threat Detection" class="service-icon" />
                    <h4>Comprehensive Security Management</h4>
